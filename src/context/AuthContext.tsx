...
export function AuthProvider({ children }: { children: ReactNode }) {
  ...
  const signUp = async (email: string, password: string, name: string, extra?: Record<string, string>) => {
  ...
  const signIn = async (email: string, password: string, department?: string) => {
